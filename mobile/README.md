...
```env
EXPO_PUBLIC_API_BASE_URL=http://109.110.188.181/api/hydroponics
EXPO_PUBLIC_LEDGER_API_BASE_URL=http://109.110.188.181/api/hydroponics
EXPO_PUBLIC_MQTT_BROKER_URL=ws://109.110.188.181/mqtt
...
The current default VPS target for this project is `109.110.188.181`.
