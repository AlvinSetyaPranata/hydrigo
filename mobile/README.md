...
```env
EXPO_PUBLIC_API_BASE_URL=http://43.156.89.66:9000/api/hydroponics
EXPO_PUBLIC_LEDGER_API_BASE_URL=http://43.156.89.66:9000/api/hydroponics
EXPO_PUBLIC_MQTT_BROKER_URL=ws://43.156.89.66:9000/mqtt
...
The current default VPS target for this project is `43.156.89.66:9000`.
